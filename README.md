...
## Overview
This is a Flask web app which predicts the selling price of a car using multiple linear regression model made my me and my friend Nishith: [https://github.com/Nishith-Reddy](https://github.com/Nishith-Reddy)
